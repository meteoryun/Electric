...
<script language="javascript"> 
  function checkchar(){
	  	...
	  	if(document.Form2.stationRunMsg.value.length>2500){
	  
	     	alert("站点运行情况字数不能超过2500字");
	     	return;
	  	}
	  	if(document.Form2.deviceRunMsg.value.length>2500){
	  
	     	alert("设备运行情况字数不能超过2500字");
	     	return;
	  	}
  		document.Form2.action="${pageContext.request.contextPath }/system/runMonitor_save.action";
  ...
  function checkTextAreaLen(){
  		var stationRunMsg = new Bs_LimitedTextarea('stationRunMsg', 2500); 
        stationRunMsg.infolineCssStyle = "font-family:arial; font-size:11px; color:gray;";
        stationRunMsg.draw();	
  	
        var deviceRunMsg = new Bs_LimitedTextarea('deviceRunMsg', 2500); 
        deviceRunMsg.infolineCssStyle = "font-family:arial; font-size:11px; color:gray;";
        deviceRunMsg.draw();	
  }
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#f5fafe" colspan=3>			
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<div id="showInfomation" style="visibility: hidden;position: absolute;"></div>
							<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
								<td style="HEIGHT:22px" align="center" width="40%">
									<div class="scrollStyle" align="left" onmouseover="showInfoWithPanel(this)" onmouseout="hiddenInfoPanel(this)" style="table-layout:fixed;">
										<s:property value="stationRunMsg"/>
									</div>
								</td>
								<td style="HEIGHT:22px" align="center" width="40%">
									<div class="scrollStyle" align="left" onmouseover="showInfoWithPanel(this)" onmouseout="hiddenInfoPanel(this)" style="table-layout:fixed;">
										<s:property value="deviceRunMsg"/>
									</div>
								</td>
	...
	<table id="opperate2" cellspacing="1" cellpadding="5" width="90%" align="center" bgcolor="#f5fafe" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
				<s:textarea name="stationRunMsg" id="stationRunMsg"   style="width: 500px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('stationRunMsg');"></s:textarea>
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
				<s:textarea name="deviceRunMsg" id="deviceRunMsg"  style="width: 500px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('deviceRunMsg');"></s:textarea>
			</td>
