...
<HTML>
	<HEAD>
		...
		function changetype(){
		  ...
		  if(document.Form1.typeKey.value=="jerrynew"){
		     ...
		     //dictTbl
		    $("#Form2 #dictTbl tbody tr:gt(0)").remove();
				
		    $("#Form2 #dictTbl tbody").append('<tr>'+
			   '<td class="ta_01" align="center"  width="20%">1</td>'+
			   '<td class="ta_01" align="center"  width="60%">' +
			   '<input name="itemnames" type="text"  size="45" maxlength="25"></td>'+
			   '<td class="ta_01" align="center"  width="20%"></td>'+
			'</tr>');
		     //Pub.submitActionWithForm('Form2','${pageContext.request.contextPath }/system/dataDictionary_edit.action','Form1');
     ...
     function saveDict(){
	      ...
	      if(document.Form1.typeKey.value=="jerrynew"){
	         ...
	         var allkeywords= document.Form1.typeKey;
	         for(var i=0;i<allkeywords.length;i++){
	          ...
	          document.Form2.keywordname.value=document.Form1.typeKey.value;
	      ...
	      document.Form2.action="${pageContext.request.contextPath}/system/dataDictionary_save.action";
...
function insertRows(){
	...
	$tdName.html("<input name=\"itemnames\" type=\"text\" id=\""+tempRow+"\" size=\"45\" maxlength=25>");
			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="left"  width="30%" >
						...
						<s:select list="top" name="typeKey" cssClass="bg" cssStyle="width:180px" onchange="changetype()"
								  headerKey="jerrynew" headerValue="请选择">
						</s:select>
					</td>
				...
				<tr height=10>
					<td colspan=3 align="right">
					   <input type="button" name="saveitem" value="添加选项" style="font-size:12px;color:black;height=20px;width=80px" onClick="insertRows()">
					 </td>
				 </tr>
			</TBODY>
		</table>
