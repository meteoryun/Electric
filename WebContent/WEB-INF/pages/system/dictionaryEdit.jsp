     ...
     <td >
	   <table cellspacing="0"   cellpadding="1" rules="all" bordercolor="gray" border="1" id="dictTbl"
		    style="BORDER-RIGHT:gray 1px solid; BORDER-TOP:gray 1px solid; BORDER-LEFT:gray 1px solid; WIDTH:100%; WORD-BREAK:break-all; BORDER-BOTTOM:gray 1px solid; BORDER-COLLAPSE:collapse; BACKGROUND-COLOR:#f5fafe; WORD-WRAP:break-word">
			    ...
			    <s:iterator>
				     <tr>
					   <td class="ta_01" align="center"  width="20%"><s:property value="itemCode"/></td>
					   <td class="ta_01" align="center"  width="60%">
					   <input id='<s:property value="itemCode"/>' name="itemnames" type="text" value='<s:property value="itemName"/>'  size="45" maxlength="25"></td>
					   <td class="ta_01" align="center"  width="20%">
					   	<a href="#" onclick='delTableRow(<s:property value="itemCode"/>)'>
