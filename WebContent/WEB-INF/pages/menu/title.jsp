    ...
    <td width="18%" height="19" bgcolor="#0965CA" align="center">
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <A href="${pageContext.request.contextPath}/menu/loading.action" target="mainFrame"><font color="#FFFFFF"><b>返回首页</b></font></a>
          <font color="#FFFFFF"><b>|</b></font>
          <A href="${pageContext.request.contextPath}/system/login_out.action"   target="_top"> <font color="#FFFFFF"><b>重新登录</b></font></A>
          <font color="#FFFFFF"><b>|</b></font>
          </td>
        </tr>
      </table>
